...
function _M.GetInfo()
	...
	MANGAINFO.Authors   = x.XPathStringAll('//div[@class="y6x11p" and contains(., "' .. XPathTokenAuthors .. '")]/span')
	MANGAINFO.Genres    = x.XPathStringAll('//div[@class="mt-15"]/a')
	MANGAINFO.Status    = MangaInfoStatusIfPos(x.XPathString('//div[@class="y6x11p" and contains(., "' .. XPathTokenStatus .. '")]/span'),
