...
function _M.GetInfo()
	...
	MANGAINFO.AltTitles = x.XPathString('//ul[contains(@class, "manga-info")]/li[contains(., "Other names")]/substring-after(., ":")')
	MANGAINFO.CoverLink = MaybeFillHost(MODULE.RootURL, x.XPathString('(//img[contains(@class, "thumbnail")])[1]/@src'))
